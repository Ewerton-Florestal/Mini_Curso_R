# -*- coding: utf-8 -*-
"""Mini_Curso_Fat2DIC.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zSVs49pqSr4vHU6KRlDhyYEgi7QhNOHJ
...
# Importando os dados
dados <- read_excel('/content/mini_curso_fat2_dic.xlsx')
...
# Avaliar distribuição da variável "diametro"
hist(dados$diametro,
...
# **Passo 8: ANOVA e Teste de Médias Fatorial DIC**

**Agora realizamos a análise de variância e o teste de comparação de médias.**
"""

# ANOVA e Teste de Tukey para DIC
fat2.dic(dados$clones, dados$espacamento, dados$diametro,
    quali=c(TRUE, FALSE),       # Variável qualitativa (tratamento)
...
"""**📌 O fat2.dic() realiza a ANOVA e o Teste de Tukey para um Fatorial duplo em Delineamento Inteiramente Casualizado (DIC).**
